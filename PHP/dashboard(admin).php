...
$sql= "SELECT * FROM library_registration";
...
<section>
    <div class="sidebar">
        ...
        <ul class="nav">
            <li class="active"><a href="dashboard(admin).php"><i class="fa fa-windows"></i>Dashboard</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Period"><a class="btn btn-danger" href="delete.php?userid1=<?php echo $result['user_id']?>">Delete</a></td>
