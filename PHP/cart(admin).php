...
<section>
    <div class="sidebar">
        ...
        <ul class="nav">
            ...
            <li class="active"><a href="cart(admin).php"><i class="fa fa-pie-chart"></i>Add to Cart</a></li>
    ...
    <div class="main">
        ...
        <div class="notification-div">
            ...
            <p><a class="a1" href="#">Here's some of the new books which are in demand!</a></p>         
        </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Period"><a class="btn btn-danger" href="delete4.php?userid1=<?php echo $result['id']?>">Delete</a></td>
    </tr>
      <?php
      }
      ?>
