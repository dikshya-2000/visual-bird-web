...
<section>
    <div class="sidebar">
        ...
        <ul class="nav">
            ...
            <li class="active"><a href="books1(admin).php"><i class="fa fa-shopping-bag"></i>Home Books List</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Period"><a class="btn btn-danger" href="delete2.php?userid1=<?php echo $result['user_id']?>">Delete</a></td>
      <td><a class="btn btn-info" href="edit.php?user_id=<?php echo $result['user_id']?>">Update</a></td>
