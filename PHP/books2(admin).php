...
<section>
    <div class="sidebar">
        ...
        <ul class="nav">
            ...
            <li class="active"><a href="books2(admin).php"><i class="fa fa-shopping-bag"></i>Shop Books List</a></li>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td data-label="Amount"><?php echo $result['price'] ?></td>
      <td data-label="Period"><img src="<?php echo 'images/'.$result['photo']?>" width="100" height="100"></td>
      <td data-label="Period"><a class="btn btn-danger" href="delete3.php?userid1=<?php echo $result['user_id']?>">Delete</a></td>
      <td><a class="btn btn-info" href="edit1.php?user_id=<?php echo $result['user_id']?>">Update</a></td>
    </tr>
      <?php
      }
      ?>
